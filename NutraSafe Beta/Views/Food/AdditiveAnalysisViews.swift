...
enum AdditiveOverrides {
    ...
    private static let overrides: [String: AdditiveOverrideData] = [
        ...
        "glucose syrup": .init(displayName: "Glucose syrup", whatItIs: "Super-concentrated liquid sugar made by breaking down starch with enzymes. Sweeter and cheaper than regular sugar, so manufacturers love it.", originSummary: "🧪 Made by enzymatically breaking down corn or wheat starch into glucose.", riskSummary: "Pure sugar with no nutritional value. Contributes to blood sugar spikes.", riskLevel: .moderateRisk),
        ...
        "maltodextrin": .init(displayName: "Maltodextrin", whatItIs: "A super-processed starch powder that dissolves instantly. Used as a thickener, filler, and to bulk up protein powders.", originSummary: "🧪 Made by partially breaking down starch (usually corn) with enzymes and acids.", riskSummary: "Spikes blood sugar faster than table sugar despite not tasting sweet. Basically empty calories.", riskLevel: .moderateRisk),
