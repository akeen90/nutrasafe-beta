...
enum AdditiveOverrides {
    ...
    private static let overrides: [String: AdditiveOverrideData] = [
        ...
        "e951": .init(displayName: "Aspartame", whatItIs: "An artificial sweetener about 200 times sweeter than sugar. Made from two amino acids, it's in most diet drinks. One of the most studied food additives ever!", originSummary: "🧪 Synthetic. Made from two amino acids.", riskSummary: "Safe for most people at normal consumption. NOT suitable for people with PKU (phenylketonuria).", riskLevel: .moderateRisk),
        "aspartame": .init(displayName: "Aspartame", whatItIs: "An artificial sweetener about 200 times sweeter than sugar. Made from two amino acids, it's in most diet drinks. One of the most studied food additives ever!", originSummary: "🧪 Synthetic. Made from two amino acids.", riskSummary: "Safe for most people at normal consumption. NOT suitable for people with PKU (phenylketonuria).", riskLevel: .moderateRisk),
        ...
        "e211": .init(displayName: "Sodium benzoate", whatItIs: "A preservative that stops bacteria and fungi from growing. Naturally found in cranberries and prunes, but usually made synthetically.", originSummary: "🧪 Synthetic. Related to benzoic acid found naturally in berries.", riskSummary: "Safe at permitted levels. Avoid combining with vitamin C in acidic conditions at high temperatures (rare in normal use).", riskLevel: .lowRisk),
        "sodium benzoate": .init(displayName: "Sodium benzoate", whatItIs: "A preservative that stops bacteria and fungi from growing. Naturally found in cranberries and prunes, but usually made synthetically.", originSummary: "🧪 Synthetic. Related to benzoic acid found naturally in berries.", riskSummary: "Safe at permitted levels. Avoid combining with vitamin C in acidic conditions at high temperatures (rare in normal use).", riskLevel: .lowRisk),
        ...
        "e102": .init(displayName: "Tartrazine (Yellow 5)", whatItIs: "A bright yellow synthetic dye also known as 'Yellow 5'. It's what gives custard and fizzy drinks that sunny colour. Some people are sensitive to it.", originSummary: "🧪 Synthetic azo dye made from petroleum.", riskSummary: "May affect activity and attention in some children. Products must carry a warning in the UK/EU.", riskLevel: .highRisk),
        "tartrazine": .init(displayName: "Tartrazine (Yellow 5)", whatItIs: "A bright yellow synthetic dye also known as 'Yellow 5'. It's what gives custard and fizzy drinks that sunny colour. Some people are sensitive to it.", originSummary: "🧪 Synthetic azo dye made from petroleum.", riskSummary: "May affect activity and attention in some children. Products must carry a warning in the UK/EU.", riskLevel: .highRisk),
        ...
        "e904": .init(displayName: "Shellac", whatItIs: "A shiny coating secreted by lac bugs. It's the same stuff used to make furniture polish shine! Also found on apples and sweets to give them that glossy look.", originSummary: "🐛 Secreted by lac bugs in India and Thailand. The bugs coat tree branches with this resinous substance, which is then scraped off and processed.", riskSummary: "Safe but not suitable for vegetarians or vegans.", riskLevel: .noRisk),
        "shellac": .init(displayName: "Shellac", whatItIs: "A shiny coating secreted by lac bugs. It's the same stuff used to make furniture polish shine! Also found on apples and sweets to give them that glossy look.", originSummary: "🐛 Secreted by lac bugs in India and Thailand. The bugs coat tree branches with this resinous substance, which is then scraped off and processed.", riskSummary: "Safe but not suitable for vegetarians or vegans.", riskLevel: .noRisk),
