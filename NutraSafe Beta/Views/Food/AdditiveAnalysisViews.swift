...
enum AdditiveOverrides {
    ...
    private static let overrides: [String: AdditiveOverrideData] = [
        ...
        "e322": .init(displayName: "Lecithin", whatItIs: "Usually extracted from soy or egg yolks. It's an emulsifier that stops oil and water from separating - the unsung hero of chocolate bars everywhere!", originSummary: "Usually from soybeans or sunflower seeds; occasionally from eggs.", riskSummary: "Safe and natural. An important nutrient for brain health.", riskLevel: .noRisk),
        "lecithin": .init(displayName: "Lecithin", whatItIs: "Usually extracted from soy or egg yolks. It's an emulsifier that stops oil and water from separating - the unsung hero of chocolate bars everywhere!", originSummary: "Usually from soybeans or sunflower seeds; occasionally from eggs.", riskSummary: "Safe and natural. An important nutrient for brain health.", riskLevel: .noRisk),

        // Low risk - plant-derived gums and thickeners
        "e415": .init(displayName: "Xanthan gum", whatItIs: "A slimy substance produced by bacteria during fermentation. Sounds gross, but it's brilliant at making sauces smooth and gluten-free baking possible!", originSummary: "Made by fermenting sugar with a natural bacterium.", riskSummary: "Generally safe. Very high amounts may cause mild digestive effects in sensitive people.", riskLevel: .lowRisk),
        "xanthan gum": .init(displayName: "Xanthan gum", whatItIs: "A slimy substance produced by bacteria during fermentation. Sounds gross, but it's brilliant at making sauces smooth and gluten-free baking possible!", originSummary: "Made by fermenting sugar with a natural bacterium.", riskSummary: "Generally safe. Very high amounts may cause mild digestive effects in sensitive people.", riskLevel: .lowRisk),
        "xanthan": .init(displayName: "Xanthan gum", whatItIs: "A slimy substance produced by bacteria during fermentation. Sounds gross, but it's brilliant at making sauces smooth and gluten-free baking possible!", originSummary: "Made by fermenting sugar with a natural bacterium.", riskSummary: "Generally safe. Very high amounts may cause mild digestive effects in sensitive people.", riskLevel: .lowRisk),
        ...
        "e407": .init(displayName: "Carrageenan", whatItIs: "Extracted from red seaweed harvested from the ocean. It's been used in Irish cooking for centuries - nature's thickener!", originSummary: "🌱 Extracted from red seaweed (Irish moss) harvested from the ocean.", riskSummary: "Food-grade carrageenan is approved as safe. Some people with digestive sensitivity may prefer to limit it.", riskLevel: .lowRisk),
        "carrageenan": .init(displayName: "Carrageenan", whatItIs: "Extracted from red seaweed harvested from the ocean. It's been used in Irish cooking for centuries - nature's thickener!", originSummary: "🌱 Extracted from red seaweed (Irish moss) harvested from the ocean.", riskSummary: "Food-grade carrageenan is approved as safe. Some people with digestive sensitivity may prefer to limit it.", riskLevel: .lowRisk),
        ...
        "dextrose": .init(displayName: "Dextrose", whatItIs: "Pure glucose in powdered form. Your body absorbs it instantly for quick energy - which sounds good until you crash 30 minutes later.", originSummary: "🌽 Refined from cornstarch.", riskSummary: "Rapid blood sugar spike. Use in moderation.", riskLevel: .lowRisk),
