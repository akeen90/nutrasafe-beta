    ...
    func submitIngredientSubmission(foodName: String, brandName: String?, 
        ...
        Task {
            try await submitToBackendForFullProcessing(
                ...
                pendingId: pendingVerification.id.uuidString
            )
        }
        
        return pendingVerification.id.uuidString
    }
    ...
    var body: some View {
        NavigationView {
            ...
            if !workoutManager.isInWorkoutView {
                VStack {
                    Spacer()
                    Text("Custom Tab Bar Placeholder")
                        .padding()
            ...
            if selectedTab == .diary && !selectedFoodItems.isEmpty {
                VStack {
                    Spacer()
                    Text("Persistent Bottom Menu Placeholder")
                        .padding()
...
// MARK: - DiaryTabView moved to separate file
...
// End of DiaryTabView - see extracted file for implementation
    ...
    var body: some View {
        HStack {
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text(DateFormatter.shortDate.string(from: workout.startTime ?? Date()))
                    .font(.caption)
                    .foregroundColor(.secondary)
            }
...
//     }
// }
// End of DiaryMealCard - see extracted file for implementation
...
//     }
// }
// End of DiaryFoodRow - see extracted file for implementation
...
//     }
// }
// End of DiaryExerciseSummaryCard - see extracted file for implementation
...
//     }
// }
// End of DiaryExerciseStat - see extracted file for implementation
...
//     }
// }
// End of DiaryExerciseCard - see extracted file for implementation
...
// End of DiaryExerciseRow - see extracted file for implementation
...
// MARK: - SlimActionButton moved to separate file
...
//     }
// }
// End of SlimActionButton - see extracted file for implementation



// MARK: - SlimButtonStyle moved to separate file
...
//     }
// }
// End of SlimButtonStyle - see extracted file for implementation



// MARK: - PremiumActionButton moved to separate file
...
//     }
// }
// End of PremiumActionButton - see extracted file for implementation



// MARK: - PremiumButtonStyle moved to separate file
...
//     }
// }
// End of PremiumButtonStyle - see extracted file for implementation



// MARK: - CompactActionButton moved to separate file
...
//     }
// }
// End of CompactActionButton - see extracted file for implementation



// MARK: - ActionButton moved to separate file
...
//     }
// }
// End of ActionButton - see extracted file for implementation
...
struct ExerciseTabView: View {
    ...
    var body: some View {
        Text("Exercise Tab - Implementation Moved to Views/ExerciseTabView.swift")
            .foregroundColor(.secondary)
    }
}

// MARK: - Exercise Sub-Tab Types
...
// MARK: - Tab Views properly imported from separate files

struct AddTabView: View {
    @Binding var selectedTab: TabItem

    var body: some View {
        Text("Add Tab - Implementation Moved to Views/AddTabView.swift")
            .foregroundColor(.secondary)
    }
}

// MARK: - Enhanced Workout Navigation Overlay
// The WorkoutNavigationOverlay & Rest Timer System has been extracted to Views/Exercise/WorkoutNavigationOverlays.swift
