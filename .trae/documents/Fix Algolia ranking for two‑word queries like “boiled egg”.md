...
1. Strengthen synonym re‑ranking to be word‑aware.
...
1. Optional (only if noise persists): reduce ingredient noise.
...
1. Edit `rankResultsForSynonymSearch(...)`:
...
1. Build & verify on device/simulator:
