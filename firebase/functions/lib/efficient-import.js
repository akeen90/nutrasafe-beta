...
exports.addVerifiedFoodComplete = void 0;
...
exports.addVerifiedFoodComplete = functions.https.onRequest(async (req, res) => {
    // Set CORS headers
    ...
    try {
        ...
        const { foodName, brandName, barcode, extractedIngredients, category, nutritionData, servingSize, servingQuantity, packaging, stores, countries, nutritionGrade, novaGroup, imageFrontUrl, imageNutritionUrl, imageIngredientsUrl, source, completeness, isUKProduct, verifiedBy } = requestData;
        if (!foodName) {
...
// Export the function
exports.default = exports.addVerifiedFoodComplete;
//# sourceMappingURL=efficient-import.js.map