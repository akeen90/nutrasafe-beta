...
exports.batchUpdateFoods = exports.scanDatabaseIssues = void 0;
 ...
 */
exports.scanDatabaseIssues = functionsV2.https.onRequest({
 ...
 */
exports.batchUpdateFoods = functionsV2.https.onRequest({
    secrets: [algoliaAdminKey],
    cors: true,
}, async (req, res) => {
    // CORS headers
