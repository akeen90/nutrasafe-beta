...
exports.clearQueryRules = exports.getQueryRulesStats = exports.configureQueryRules = void 0;
 ...
 */
exports.configureQueryRules = functions.https.onRequest({
    ...
    for (const indexName of ALL_INDICES) {
        try {
            await client.saveRules({
                indexName,
                rules: QUERY_RULES, // Cast for SDK compatibility
 ...
 */
exports.getQueryRulesStats = functions.https.onRequest({
    secrets: [algoliaAdminKey],
    cors: true,
}, async (request, response) => {
    const client = (0, algoliasearch_1.algoliasearch)(ALGOLIA_APP_ID, algoliaAdminKey.value());
 ...
 */
exports.clearQueryRules = functions.https.onRequest({
    secrets: [algoliaAdminKey],
    cors: true,
}, async (request, response) => {
...
//# sourceMappingURL=algolia-query-rules.js.map