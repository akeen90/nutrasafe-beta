...
exports.scanProductComplete = void 0;
 ...
 */
exports.scanProductComplete = (0, https_1.onCall)({
    cors: true,
    ...
    if (!images || images.length === 0) {
        throw new https_1.HttpsError('invalid-argument', 'At least one image must be provided');
    }
    if (images.length > 5) {
        throw new https_1.HttpsError('invalid-argument', 'Maximum 5 images allowed');
    }
    try {
        ...
        throw new https_1.HttpsError('internal', 'Failed to scan product', { originalError: String(error) });
    }
});
function buildProductScanPrompt() {
...
//# sourceMappingURL=scan-product-complete.js.map