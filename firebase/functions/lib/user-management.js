...
exports.getPremiumOverrideStatus = exports.setPremiumOverride = exports.bulkAddToMailchimp = exports.getAuthenticatedEmails = exports.getUserAnalytics = exports.deleteUsers = exports.updateUser = exports.addUser = exports.getUsers = void 0;
...
exports.addUser = functions.https.onCall(async (data, context) => {
    ...
    await requireAdmin(context);
    try {
        const { email, displayName, phoneNumber, role = 'user', allergens = [], preferences = {} } = data;
        if (!email) {
    ...
    try {
        ...
        users.forEach(user => {
            if (user.allergens && Array.isArray(user.allergens)) {
                user.allergens.forEach((allergen) => {
...
exports.setPremiumOverride = functions.https.onCall(async (data, context) => {
    // Verify admin access
    await requireAdmin(context);
...
exports.getPremiumOverrideStatus = functions.https.onCall(async (data, context) => {
    // Verify admin access
    await requireAdmin(context);
