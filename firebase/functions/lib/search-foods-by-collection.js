...
exports.searchFoodsByCollection = void 0;
...
exports.searchFoodsByCollection = functions.https.onRequest(async (req, res) => {
    // Set CORS headers
    ...
    try {
        ...
        const collection = req.query.collection || 'verifiedFoods';
...
//# sourceMappingURL=search-foods-by-collection.js.map