...
exports.addVerifiedFoodManuallyEfficient = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
// Efficient version of addVerifiedFoodManually with fixed duplicate detection
exports.addVerifiedFoodManuallyEfficient = functions.https.onRequest(async (req, res) => {
    // Set CORS headers
...
//# sourceMappingURL=efficient-add-food.js.map