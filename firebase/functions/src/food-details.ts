...
export const getFoodDetails = functions.https.onRequest(async (req, res) => {
  // Set CORS headers
  ...
  try {
    const foodId = (req.query.id as string) || (req.body && req.body.foodId) || (req.query.foodId as string);
